...
if __name__ == '__main__':
    ...
    CSV_PATH = r'.\credit_output_binned.csv'

    df = pd.read_csv(CSV_PATH)

    rules = [[[[10, 4, 'female div/dep/mar 278']], [[19, 4, 1]]], [[[7, 4, '(-0.001, 7.154]'], [15, 4, 'none'], [18, 4, 'skilled']], [[19, 4, 1]]], [[[2, 4, 5], [15, 4, 'none'], [18, 4, 'skilled']], [[19, 4, 1]]],
        [[[7, 4, '(-0.001, 7.154]'], [11, 4, 'none'], [18, 4, 'skilled']], [[19, 4, 1]]],
        [[[2, 4, 5], [15, 4, 'none'], [24, 4, 'GOOD']], [[19, 4, 1]]],
        [[[7, 4, '(-0.001, 7.154]'], [11, 4, 'none'], [16, 4, 'own']], [[2, 4, 5]]],
        [[[11, 4, 'none'], [15, 4, 'none'], [18, 4, 'skilled']], [[19, 4, 1]]],
        [[[7, 4, '(-0.001, 7.154]'], [11, 4, 'none'], [17, 4, 1]], [[19, 4, 1]]],
        [[[2, 4, 5], [15, 4, 'none'], [21, 4, 'YES']], [[19, 4, 1]]],
        [[[15, 4, 'none'], [16, 4, 'own'], [18, 4, 'skilled']], [[19, 4, 1]]],
    ]
